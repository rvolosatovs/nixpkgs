  ...
  config = mkIf cfg.enable (mkMerge [
    {
      ...
      systemd.services."enarx@".serviceConfig.ReadOnlyPaths = ["/"];
    ...
    (mkIf (cfg.backend == "sgx") {
      ...
      systemd.services.sgx-register.serviceConfig.ExecPaths = ["/nix/store"];
      systemd.services.sgx-register.serviceConfig.ExecStart = "-${cfg.package}/bin/enarx platform sgx register";
      systemd.services.sgx-register.serviceConfig.InaccessiblePaths = ["-/lost+found"];
      ...
      systemd.services.sgx-register.serviceConfig.NoExecPaths = ["/"];
      ...
      systemd.services.sgx-register.serviceConfig.ReadOnlyPaths = ["/"];
      ...
      systemd.services.sgx-register.serviceConfig.UMask = "0777";
      systemd.services.sgx-register.unitConfig.AssertPathIsReadWrite = ["/dev/sgx_provision"];
      ...
      systemd.services."enarx@".unitConfig.AssertPathIsReadWrite = ["/dev/sgx_enclave"];
    })
    (mkIf (cfg.backend == "sev") {
      ...
      systemd.services."enarx@".unitConfig.AssertPathIsReadWrite = [
        "/dev/kvm"
        "/dev/sev"
      ];

      # NOTE: this service should be separated from Enarx in the future.
      ...
      systemd.services.vcek-update.serviceConfig.ExecPaths = ["/nix/store"];
      systemd.services.vcek-update.serviceConfig.ExecStartPre = ''+${pkgs.writeShellScript "init.sh" ''
      ...
      systemd.services.vcek-update.serviceConfig.InaccessiblePaths = ["-/lost+found"];
      ...
      systemd.services.vcek-update.serviceConfig.NoExecPaths = ["/"];
      ...
      systemd.services.vcek-update.serviceConfig.ReadOnlyPaths = ["/"];
      systemd.services.vcek-update.serviceConfig.ReadWritePaths = ["/var/cache/amd-sev"];
      ...
      systemd.services.vcek-update.serviceConfig.UMask = "0002";
      systemd.services.vcek-update.unitConfig.AssertPathIsReadWrite = [
        "/dev/sev"
        "/var/cache/amd-sev"
      ];
